...
import { getProject, updateProject, deleteProject, getTemplate } from '@/lib/monetization-api';
...
import type { ProjectDetail, TemplateDetail, DecisionPoint } from '@/types/monetization';
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center py-20">
          ...
          <Button onClick={() => router.push('/monetization')}>Back to Projects</Button>
        </div>
      </div>
    );
  }
