  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-primary-dark">Approvals</h1>
          <p className="mt-1 text-secondary-dark">Messages generated by workflows that require manual approval before sending.</p>
        </div>
