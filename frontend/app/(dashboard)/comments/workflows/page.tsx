// frontend/app/(dashboard)/comments/workflows/page.tsx
'use client';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-primary-dark">Workflows</h1>
          <p className="mt-1 text-secondary-dark">Design and automate interaction handling. This is a fresh redesign replacing legacy Automations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/comments/workflows/active" className="block rounded-md border border-[var(--border)] hover-background">
        ...
        <Link href="/comments/workflows/approvals" className="block rounded-md border border-[var(--border)] hover-background">
          <Card className="card-background border-0">
            <CardHeader>
        ...
        <Link href="/comments/workflows/create" className="block rounded-md border border-[var(--border)] hover-background">
          <Card className="card-background border-0">
            <CardHeader>
