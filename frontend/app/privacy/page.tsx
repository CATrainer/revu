...
import { privacyPolicyContent } from "@/lib/privacy-content";

export default function PrivacyPage() {
  const handleDownload = () => {
    // Create a blob with the content
    const blob = new Blob([privacyPolicyContent], { type: 'text/plain' });
    const url = window.URL.createObjectURL(blob);
    const a = document.createElement('a');
    a.href = url;
    a.download = 'Repruv-Privacy-Policy.txt';
          ...
          <div className="bg-gradient-to-r from-green-600/10 to-green-500/5 p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="text-center sm:text-left">
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">Questions About Your Privacy?</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  If you have any questions about our privacy practices or need to exercise your data rights, please contact us at:
                </p>
