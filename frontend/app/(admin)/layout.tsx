...
export default function AdminLayout({
  ...
  <div className="card-background border-b border-[var(--border)]">
                ...
                <Link
                  ...
                  className={`${
                    item.current
                      ...
                      : 'border-transparent text-secondary-dark hover:text-primary-dark hover:border-[var(--border)]'
                  } group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm`}
                >
                  <Icon
                    className={`${
                      item.current ? 'text-[var(--brand-primary)]' : 'text-muted-dark group-hover:text-secondary-dark'
                    } -ml-0.5 mr-2 h-5 w-5`}
                    aria-hidden="true"
                  />
                  <span>{item.name}</span>
