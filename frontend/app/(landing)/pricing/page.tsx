      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-4xl md:text-5xl font-bold text-[var(--brand-primary)] mb-2">Free Plan</h3>
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  ...
                  <span className={feature.included ? 'text-secondary-dark font-bold' : 'text-gray-400 font-bold'}>{feature.text}</span>
                </div>
              ))}
            </div>
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-bold text-[var(--brand-primary)] mb-2">Pro Plan</h3>
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-[var(--success)] flex-shrink-0 mt-0.5" />
                  <span className="text-secondary-dark font-bold">{feature}</span>
                </div>
              ))}
            </div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            <h3 className="text-4xl md:text-5xl font-bold text-[var(--brand-primary)] mb-2">Agency Plan</h3>
