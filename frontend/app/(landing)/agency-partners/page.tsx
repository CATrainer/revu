...
export default function AgencyPartnersPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {whyPartnerBenefits.map((benefit, index) => (
              ...
              >
                <benefit.icon className="w-12 h-12 mb-4" style={{
                  color: index === 0 ? '#06b6d4' : index === 1 ? '#a78bfa' : '#f59e0b'
                }} />
      ...
      {/* Final CTA */}
      <section className="py-8 md:py-12 section-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-900 dark:text-black mb-8 max-w-2xl mx-auto">
            ...
            <p className="text-sm text-gray-900 dark:text-black mt-6">
